                              ...
                              _isToggleAnimation
                                      ...
                                      builder: (context, child) {
                                        if (!_isLiked) {
                                          return Transform.translate(
                                            ...
                                            child: Opacity(
                                              opacity:
                                                  1 - _dislikeAnimation.value,
                                              child: Icon(
                                                Icons.thumb_down,
                                                color:
                                                    widget.themeProvider.cRed,
                                                size: 36,
                                              ),
                                            ),
                                          );
                                  ...
                                  : GestureDetector(
                                      ...
                                      child: Icon(
                                        ...
                                        color:
                                            widget.themeProvider.cTextDisabled,
                                        size: 36,
                                      ),
                                    ),
                            ],
                            ...
                            ? TextField(
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    ...
                                    if (_charCount >= 0 && _charCount <= 200) {
                                      _canSubmit = true;
                                    } else {
                                      _canSubmit = false;
                                    }
                                ...
                                maxLines: null,
                                style: widget
                                    .themeProvider.tTextNormal, // Text color
                              )
                            : Container()
                        : Container(),
